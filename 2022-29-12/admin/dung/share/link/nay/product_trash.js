$(document).ready(function() {
    ...
    fetch("http://103.173.154.17:8080/vintage/products/trash").then(
...
function myFunction(id) {
    ...
    if (confirm(text) == true) {
        fetch('http://103.173.154.17:8080/vintage/product/delete/' + id, {
            ...
            .then(response => {window.location.href="product_trash.html";});
    }
}
...
function trashBack(id) {
    ...
    if (confirm(text) == true) {
        fetch('http://103.173.154.17:8080/vintage/product/trash/' + id, {
            method: 'PUT',
            })
            .then(response => {window.location.href="product_trash.html";});
    }
